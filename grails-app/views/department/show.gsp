	...
	<body>
		...
		<div id="show-department" class="content scaffold-show" role="main">
			...
			<ol class="property-list department">
				...
				<g:if test="${departmentInstance?.memo}">
				<li class="fieldcontain">
					<span id="memo-label" class="property-label"><g:message code="department.memo.label" default="Memo" /></span>
					
						<span class="property-value" aria-labelledby="memo-label"><g:fieldValue bean="${departmentInstance}" field="memo"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${departmentInstance?.emp}">
				<li class="fieldcontain">
					<span id="emp-label" class="property-label"><g:message code="department.emp.label" default="Emp" /></span>
					
						<g:each in="${departmentInstance.emp}" var="e">
						<span class="property-value" aria-labelledby="emp-label"><g:link controller="employee" action="show" id="${e.id}">${e?.encodeAsHTML()}</g:link></span>
						</g:each>
